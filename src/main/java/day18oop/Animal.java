...
public class Animal {
    ...
    5) Child class daki methodun occess modifier i Parent class daki override edilmis (Overriden Method) un acces modifier'indan
    ...
    Overriden Method ==> private   --- Overriding method ==> override olmazki access modifier i olsun (Bknz 4. kural)
    ...
    9) Method'un return type i void ise Overriding yaparken return type degistirilemez
